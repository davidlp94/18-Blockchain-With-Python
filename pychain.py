...
input_value_sender = st.text_input("Enter Sender Information")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
input_value_receiver = st.text_input("Enter Receiver Information")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
input_value_amount = st.text_input("Enter Amount to Send")
